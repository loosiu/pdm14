...
st.sidebar.subheader('Visualization using seaborn and plotly by pdm14')
...
with row2_1: 
    corr_x = st.selectbox("Correlation - X variable", options=df.columns, index=df.columns.get_loc("chol"))
